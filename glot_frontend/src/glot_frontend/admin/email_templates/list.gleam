...
import glot_frontend/admin/email_templates/list_managed as managed
import glot_frontend/admin/email_templates/list_message as message
import glot_frontend/admin/email_templates/list_model as model
import glot_frontend/admin/email_templates/list_view as feature_view
