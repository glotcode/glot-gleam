...
import glot_frontend/admin/job_logs/list_message.{
  type Msg, ApplyFilters, ErrorFilterSelected, JobIdFilterChanged,
  NextPageClicked, PreviousPageClicked, RequestIdFilterChanged,
}
import glot_frontend/admin/job_logs/list_model.{type Model}
  ...
  admin_layout.page_with_panel_class(
    ...
    content: [
      ...
      html.div([attribute.class("admin-page__group")], [
        ...
        admin_status.loadable_status(model.page, "Loading job logs..."),
