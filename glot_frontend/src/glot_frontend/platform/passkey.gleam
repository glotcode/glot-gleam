...
import glot_frontend/ui/passkey.{
  type AuthenticationResult, type PasskeyError, type PasskeyErrorKind,
  type RegistrationResult, AuthenticationResult, CancelledPasskey, FailedPasskey,
  PasskeyError, RegistrationResult, UnsupportedPasskey,
}
