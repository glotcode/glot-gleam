...
import glot_frontend/admin/job_logs/detail_managed as managed
import glot_frontend/admin/job_logs/detail_message as message
import glot_frontend/admin/job_logs/detail_model as model
import glot_frontend/admin/job_logs/detail_view as feature_view
